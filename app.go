...
import (
    ...
    "github.com/datahome73/democoin/x/democoin"
...
type demoCoinApp struct {
    *bam.BaseApp
    ...
    nsKeeper            democoin.Keeper
}

// NewdemoCoinApp is a constructor function for demoCoinApp
func NewdemoCoinApp(logger log.Logger, db dbm.DB) *demoCoinApp {
    ...
    app.nsKeeper = democoin.NewKeeper(
        app.bankKeeper,
        app.keyNS,
        app.cdc,
    )
    ...
    app.Router().
        ...
        AddRoute("nameservice", democoin.NewHandler(app.nsKeeper))
